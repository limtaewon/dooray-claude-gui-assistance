...
### 공유소 탭
- **공유소** 탭: 두레이 커뮤니티 기반 팀 공유 스킬 목록
- 이름·설명·작성자로 검색 가능
- 내가 업로드한 스킬은 "내 스킬" 배지 + **공유 해제** 버튼 노출
- **내 스킬 공유하기** 버튼 → '내 스킬' 탭으로 이동 후 카드 메뉴에서 업로드
- 이미 공유한 스킬을 다시 업로드하면 중복 여부를 감지하고 확인 창 표시

### 위키 공유 탭
위키 저장소(두레이 위키 페이지)에 스킬을 저장/공유.
