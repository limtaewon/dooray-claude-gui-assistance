  ...
  if (error) {
    ...
    return (
      <a href={webUrl} target="_blank" rel="noreferrer"
        className="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-bg-surface border border-bg-border text-[calc(11px_*_var(--app-font-scale,1))] text-text-secondary hover:border-bg-border-strong hover:text-clauday-blue transition-colors"
        title={error}>
