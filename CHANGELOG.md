...
### 진행 예정 (후속 작업)
다음 Phase들은 별도 작업으로 분리:
- Phase 4-2: Skills / Community / Monitoring / Usage 화면 교체
- Phase 4-3: Settings 탭 구조 정리(외관/AI 모델/Dooray/MCP/데이터/정보)
- Phase 4-4: Terminal 탭 스타일 교체
- Phase 5: Dooray(Dashboard/Briefing/Watcher) 전면 교체 (feature flag 뒤)
- Phase 6: Playwright 스냅샷 + 접근성 검증
